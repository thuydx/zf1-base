...
namespace WDS\Application\Container;

use WDS\Application\Exception;
...
class DoctrineContainer
{
    ...
    private function prepareORMConfiguration(array $config = array())
    {
        ...
        $defaultEntityManager = array(
            ...
            'proxy'                   => array(
                ...
                'namespace'           => 'Proxy',
                'dir'                 => LIBRARY_PATH . '/WDS/Model/Proxy'
            ),
     ...
     *
     * @throws WDS\Application\Exception\NameNotFoundException
     *
