 ...
 *
 */
class WDS_Controller_Plugin_Debug_Plugin_Log
    ...
    implements WDS_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    public function __construct()
    {
        ...
        $this->_writer = new WDS_Controller_Plugin_Debug_Plugin_Log_Writer();
        $this->_logger = new Zend_Log($this->_writer);
        $this->_logger->addPriority('ZFLOG', self::WDSLOG);
    }
