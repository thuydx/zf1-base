...
class WDS_Controller_Plugin_Debug_Plugin_Cache 
    ...
    implements WDS_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    /**
     * Create WDS_Controller_Plugin_Debug_Plugin_Cache
     *
     * @param array $options
     * @return void
     */
    public function __construct(array $options = array())
    {
        if (!isset($options['backend'])) {
            throw new Zend_Exception("Debug: Cache plugin needs 'backend' parameter");
        }
